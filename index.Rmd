...
The good news (and bad news) is there are many tools & packages available to use for spatial analysis and mapping in R. It is probably impossible to introduce everything, but the goal of this tutorial is to show a few different ways to get spatial data into R, and visualize it. In addition, the *Resources* tab provides links to a smattering of tutorials, background info, vignettes, etc. Check it out!
