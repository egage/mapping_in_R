...
I'm going to use a method I demonstrated in a blog I wrote a few weeks ago (*[check it out here](https://ryanpeek.github.io/2017-10-24-mapping-with-sf-part-1/)*) which shows how to use a package called `rvest` to pretty quickly and easily grab data from any part of a webpage. Let's see how it works. 
