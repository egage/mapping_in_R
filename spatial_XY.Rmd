...
The simplest type of data to plot is X/Y points. You might have a `.csv` lying around with site locations, or even better, a shapefile. For this example, et's use this list of [CA hotsprings](http://www.hotspringsenthusiast.com/California.asp). It provides names, *Latitude & Longitude* and water temperatures in C and F for each hotspring. I've already downloaded the file so you can just read the file link directly into R as follows:
...
<img src="http://www.reactiongifs.com/r/2013/06/Sean_connery_raction.gif" width="500"/>
