...
text(counties_spec$lon, counties_spec$lat, labels = counties_spec$name,
     col=adjustcolor("white", alpha=0.8), font = 2, family="Roboto Condensed")
graphics::title("Selected CA Counties",
      family="Roboto Condensed")
```
...
plot(st_geometry(rivers_crop)) # a quick plot check to make sure it worked
...
text(counties_spec$lon, counties_spec$lat, labels = counties_spec$name,
     col="maroon", font = 2, family="Roboto Condensed")
graphics::title("Selected CA Counties",
      family="Roboto Condensed")
```
